package com.example.rd.verticallayouttextview;

import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;

import com.example.verticallayouttextviewlib.VerticalLayoutTextView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verticalLayoutTextView1.setText("你还sdf哈哈134哈哈3err24是要了解HTML的标识的含义。特别在Unix下的软件编译，你就不能不自己写makefile了，" +
